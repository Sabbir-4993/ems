                    ...
                    <div class="invoice p-3 mb-3" id="invoice">
                        ...
                        <div class="row invoice-info">
                            ...
                            <div class="col-sm-4 invoice-col">
                                ...
                                PI/PO Number: <b>{{$printDetails->pi_number}}</b><br>
                                <br>
                            </div>
                            <!-- /.col -->
                        </div>
                        ...
                        <div class="row">
                            <div class="col-12 table-responsive">
                                <table class="table table-striped">
                                    ...
                                    <tr>
                                        <td>{{$billingDetail->billing_date}}</td>
                                        <td>{{$billingDetail->billing_no}}</td>
                                        <td>{{$billingDetail->billing_method}}</td>
                                        <td>{{$billingDetail->billing_details}}</td>
                                        <td style="text-align:center">{{$billingDetail->billing_amount}}</td>
                                    </tr>
                                        @endforeach
                                    </tbody>
                                </table>
