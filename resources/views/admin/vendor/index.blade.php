                                        ...
                                        <td>
                                            ...
                                            <div class="modal fade" id="modal-sm{{$row->id}}">
                                                <div class="modal-dialog modal-m">
                                                    <form action="{{route('vendor.update',[$row->id])}}" method="post">
                                                        @csrf
                                                        {{method_field('PATCH')}}
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <input class="form-control @error('name') is-invalid @enderror" name="name" type="text" placeholder="" value="{{$row->vendor_name}}">
                                                                @error('name')
                                                                ...
                                                                <input class="form-control @error('phone') is-invalid @enderror" name="phone" type="text" placeholder="" value="{{$row->vendor_phone}}">
                                                                @error('phone')
                                                                <span class="invalid-feedback" role="alert">
                                                                    <strong>{{ $message }}</strong>
                                                                 </span>
                                                                ...
                                                                <input class="form-control @error('address') is-invalid @enderror" name="address" type="text" placeholder="" value="{{$row->vendor_address}}"
                                                                @error('address')
                                                                <span class="invalid-feedback" role="alert">
                                                                    <strong>{{ $message }}</strong>
                                                                 </span>
                                                                ...
                                                                <input class="form-control @error('details') is-invalid @enderror" name="details" type="text" placeholder="" value="{{$row->vendor_details }}">
                                                                @error('details')
                                                                <span class="invalid-feedback" role="alert">
                                                                    <strong>{{ $message }}</strong>
                                                                 </span>
                                            ...
                                            <button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#modal-m{{$row->id}}">
        ...
        <div class="modal-dialog modal-m">
            <form action="{{route('vendor.store')}}" method="post">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-footer justify-content-between">
                        <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                        <button type="submit" class="btn btn-info">Add vendor</button>
                    </div>
                </div>
            </form>
            <!-- /.modal-content -->
