        ...
        <form action="{{route('designation.update', [$designation->id])}}" method="post">
            ...
            <div class="card card-secondary">
                ...
                <div class="card-body">
                    ...
                    <input class="form-control @error('name') is-invalid @enderror" name="name" type="text" value="{{$designation->name}}">
                    @error('name')
                ...
                <div class="card-body">
                    ...
                    <textarea name="description" class="form-control @error('description') is-invalid @enderror" cols="30" rows="5">{{$designation->description}}</textarea>
                    @error('description')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
