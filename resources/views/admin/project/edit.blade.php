                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input class="form-control @error('project_name') is-invalid @enderror"
                                       name="project_name" type="text" placeholder="Enter Project Name" value="{{$project->project_name}}">
                                @error('project_name')
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control @error('company_name') is-invalid @enderror"
                                       name="company_name" type="text" placeholder="Enter Company/Client Name" value="{{$project->company_name}}">
                                @error('company_name')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="inputDescription" type="text"
                                          ...
                                          name="description" rows="4" placeholder="Project Description">{{$project->description}}</textarea>
                                @error('description')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control @error('address') is-invalid @enderror" name="address"
                                       type="text" placeholder="Enter Address" value="{{$project->address}}">
                                @error('address')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control @error('phone') is-invalid @enderror" name="phone"
                                       type="text" placeholder="Enter Number" value="{{$project->phone}}">
                                @error('phone')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="inputProjectLeader" name="project_leader"
                                       ...
                                       placeholder="Project Leader Name" value="{{$project->project_leader}}">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="number" id="inputEstimatedBudget" name="est_budget"
                                       ...
                                       placeholder="Enter Estimated budget" value="{{$project->est_budget}}">
                                @error('est_budget')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" id="inputSpentBudget" name="total_amount"
                                       ...
                                       placeholder="Enter Total amount spent" value="{{$project->total_amount}}">
                                @error('total_amount')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" id="inputEstimatedDuration" name="pro_duration"
                                       ...
                                       placeholder="Enter Estimated project duration" value="{{$project->pro_duration}}">
                                @error('pro_duration')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="date" name="project_start" value="{{$project->project_start}}" required=""/>
                            </div>
                            <!-- /.form-group -->
                            <div class="form-group">
                                <label for="end_date" class="col-form-label">Project End</label>
                                <input class="form-control" type="date" name="project_end" value="{{$project->project_end}}" required=""/>
                            </div>
                            <!-- /.form-group -->
                        </div>
                        <!-- /.card-body -->
